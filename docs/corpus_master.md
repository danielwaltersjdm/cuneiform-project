...
| 1.9 | Nuzi Archives (c. 1500–1350 BCE) | High (individual) | **HARD** | CDLI has 2,335 Middle Babylonian tablets; only 1 has translation. Scholarly editions (HSS, JEN, Maidman) are print-only. No bulk digital source found. |
